...
export const sectionBgLogin = `${sectionBgBase} from-cyan-300 via-indigo-300 to-green-300`
export const sectionBgLoginDark = `${sectionBgBase} from-gray-700 via-gray-900 to-black`
