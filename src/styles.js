...
export const basic = {
  ...
  asideMenuItemActive: 'font-bold text-white bg-gray-800 py-2',
...
export const white = {
  ...
  asideMenuItem: 'text-black hover:bg-gray-600 hover:bg-opacity-50',
  asideMenuItemActive: 'font-bold text-black bg-gray-200  py-2',
