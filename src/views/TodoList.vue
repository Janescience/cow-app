<template>
  <LayoutAuthenticated>
    <SectionMain>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-5 gap-5 mb-1 lg:mb-5">
        <CardBox v-if="Object.keys(todolist?.setting).length > 0" icon="formatListChecks" title="ตั้งค่าเริ่มต้น" header-icon="" class=" row-span-2" :loading="loading.todolist">
          <div  class="mb-5">
        ...
        <CardBox v-if="Object.keys(todolist?.important).length > 0" icon="formatListChecks" title="ข้อมูลที่ควรบันทึก" header-icon="" class=" row-span-2" :loading="loading.todolist">
          <div  class="mb-5">
        ...
        <CardBox v-if="Object.keys(todolist.dairy).length > 0" icon="formatListChecks" title="รายวัน" header-icon="" class=" row-span-2" :loading="loading.todolist">
          <div  class="mb-5">
        ...
        <CardBox v-if="Object.keys(todolist.monthly).length > 0" icon="formatListChecks" title="รายเดือน" header-icon="" class=" row-span-2" :loading="loading.todolist">
          <div  class="mb-5">
        ...
        <CardBox v-if="Object.keys(todolist.notification).length > 0" icon="formatListChecks" title="ครบกำหนดวันนี้" header-icon="" class=" row-span-2" :loading="loading.todolist">
          <div  class="mb-5">
