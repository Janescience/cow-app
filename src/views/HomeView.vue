    ...
    <SectionMain>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div class="grid grid-cols-1 gap-5">
          <CardBox v-if="!loading.cow" icon="cow" title="สถานะโค" class="text-center" header-icon="">
          ...
          <CardBox v-if="!loading.cow" icon="thermometerWater" title="คุณภาพนม" class="text-center" header-icon="">
            <div class="grid grid-cols-2 gap-5">
              <p class="text-left mt-2">
                คุณภาพดี
              </p>
        ...
        <Table title="คอก" :items="corrals" :datas="corralColumns" perPage="5" :loading="loading.corral" />


        <CardBox v-if="!loading.events" icon="calendarBadgeOutline" title="กำหนดการ" class="text-center" header-icon="">
          <table class="text-sm ">
            <tbody>
        ...
        <CardBox icon="calendarBadgeOutline" title="กำหนดการ" header-icon="" v-else loading />
      ...
      <div class="grid grid-cols-1 gap-5 mt-5">
        <CardBox icon="cashRegister" class="text-sm " title="ผลประกอบการ" header-icon="">
          <div class="grid lg:grid-cols-4 grid-cols-1 gap-5">
            <CardBox icon="finance" class="dark:border-gray-500" title="ราคาผันผวน" header-icon="">
              <div class="grid grid-cols-2 gap-5 ">
                <p>ค่าอาหาร/วัน</p>
                <p class="text-right">{{ expense?.fluctuate?.food ? $filters.currency(expense.fluctuate.food) : '-' }}</p>
                <p>ค่าจ้างคนงาน <br />(ตามระยะเวลาจ้าง)</p>
                <p class="text-right">{{ expense?.fluctuate?.worker ? $filters.currency(expense.fluctuate.worker) : '-' }}
                </p>
            ...
            <CardBox class="dark:border-gray-500" icon="needle" title="ดูแล" header-icon="">
              <div class="grid grid-cols-2 gap-5 grid-flow-row-dense">
                ...
                <p class="text-right">{{ expense?.care?.protection ? $filters.currency(expense.care.protection) : '-' }}
                </p>
                <!-- <p class="mt-3 font-extrabold ">รวม</p>
            ...
            <CardBox icon="accountCashOutline" class="dark:border-gray-500" title="ต้นทุน" header-icon="">
              <div class="grid grid-cols-2 gap-5">
                <p>อุปกรณ์</p>
                ...
                <p>การซ่อมบำรุง</p>
                <p class="text-right">{{ expense.cost?.maintenance ? $filters.currency(expense.cost.maintenance) : '-' }}
                </p>
            ...
            <CardBox icon="cashMultiple" class="dark:border-gray-500" title="ผลผลิต" header-icon="">
              <div class="grid grid-cols-2 gap-5 ">
                <p>น้ำนมดิบ</p>
            ...
            <CardBox icon="" class="dark:border-gray-500 text-2xl text-center text-red-500" title="" header-icon="">
            ...
            <CardBox icon="" class="dark:border-gray-500 text-2xl text-center text-green-500" title="" header-icon="">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
        <CardBox :title="'น้ำนมดิบรวมรายเดือน ปี ' + (new Date().getFullYear())" icon="chartBellCurveCumulative"
          class="lg:col-span-2" header-icon="">
          <div v-if="chartData">
            <line-chart :data="chartData" class="h-66" />
          </div>
          <div v-else>
            ไม่มีรายการรีดนม...
          </div>
        </CardBox>
        <CardBox class="text-center items-center p-5" header-icon="">
